...
>>>>>>> 869a69487f96345898a99d542c4e494537407bab
...
<<<<<<< HEAD
### Federal spending on National Fish Hatcheries <span style="font-size:small">(hover over states for info)</span>
=======
### Federal spending on Hatcheries <span style="font-size:small">(hover over states for info)</span>
>>>>>>> 869a69487f96345898a99d542c4e494537407bab
...
This table identifies the designated wilderness areas within National Wildlife Refuges. The refuges are also included under the refuge system tab. Point to Table 8. Maybe add a count of how many wilderness area per state?
...
=======
### Federal spending on Wilderness Areas <span style="font-size:small">(hover over states for info)</span>
>>>>>>> 869a69487f96345898a99d542c4e494537407bab
...
Column {data-width=800}
-----------------------------------------------------------------------
### Wilderness areas within NWRS <span style="font-size:small">(will delete later)</span>
...
<<<<<<< HEAD
### Do we need this map? Federal spending on National Monuments <span style="font-size:small">(hover over states for info)</span>
=======
### Federal spending on National Monuments <span style="font-size:small">(hover over states for info)</span>
>>>>>>> 869a69487f96345898a99d542c4e494537407bab
