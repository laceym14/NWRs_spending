...
Number of hatcheries in each state (if any) and total acres. This data does not include sites that aren't defined as a true fish hatchery. Refer to table 7.
