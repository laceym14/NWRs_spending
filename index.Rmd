...
tags$p(
  ...
  sum(state_data$other_total_secondary_acres), "ac"
)
```
...
tags$p(
  style = "font-size:1.5em; font-weight:700;",
  sum(state_data$other_total_primary_acres), "ac"
)
...
tags$p(
  style = "font-size:1.5em; font-weight:600; color:white",
  sum(hatchery_state_data$hatchery_acres), "ac."
)
...
Graph shows total acreage per National Monument. The pie chart shows monument acres within refuge boundary (NWRS Managed Monument Area) compared to acres outside boundary (Monument Area administered Under other authority).
...
tags$p(
  style = "font-size:1.5em; font-weight:600; color:white",
  sum(natmon_acres$monument_acres), "ac."
)
...
### monument areas within NWRS boundaries compared to outside managemnt
...
### Monument size (acres) <span style="font-size:small">(smallest to largest)</span>
