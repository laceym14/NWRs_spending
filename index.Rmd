...
\# Acres acquired by other agencies (the US Department of Energy, etc.)
```{r n_intra}
tags$p(
  style = "font-size:1.7em; font-weight:700;",
  sum(state_data$other_total_acres), "acres"
)
```
