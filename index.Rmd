...
#get total num of national monuments in the US
...
x <- c('Hanford Reach National Monument', 'Marianas Trench Marine National Monument', 'Northeast Canyons and Seamunts Marine National Monument', ' Pacific Remote Islands Marine National Monument', 'Papahanaumokuakea Marine National Monument', 'Rose Atoll Marine National Monument', 'World War II Valor in the Pacific National Monument')
y <- c(194450.93, 61077668, 3144320, 313941851.32, 372848597, 8609045, 6304)
...
fig <- fig %>% layout(title = "National Monuments Acreage",
                      xaxis = list(title = ""),
                      yaxis = list(title = ""))
